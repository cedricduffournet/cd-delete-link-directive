  ...
  grunt.initConfig({
    ...
    html2js: {
      app: {
        ...
        dest: 'src/template/<%= pkg.name %>.tpl.js',
        module: 'cd.ui.deleteLinkTpl'
      }
    },
    ...
    copy: {
      ...
      demo: {
        files: [
          ...
          {src: ['bower_components/angular-strap/dist/modules/popover.tpl.js'], dest: 'demo/scripts/' },
          {src: ['bower_components/angular-strap/dist/modules/tooltip.tpl.js'], dest: 'demo/scripts/' },
          {src: ['bower_components/angular-strap/dist/modules/tooltip.js'], dest: 'demo/scripts/' },
          {src: ['bower_components/angular-strap/dist/modules/popover.js'], dest: 'demo/scripts/' },
          {src: ['bower_components/angular-strap/dist/modules/dimensions.js'], dest: 'demo/scripts/' }
